...
train <- read.csv("/home/drishi/coursework/STAT 929/Time-Series-Project/train.csv")
...
tr
write.csv(submission, file = "/home/drishi/coursework/STAT 929/Time-Series-Project/1_random_forest_submission.csv", row.names=FALSE)
...
ggsave("/home/drishi/coursework/STAT 929/Time-Series-Project/2_feature_importance.png", p)